...
# Image object from a local image file
img = PhotoImage(file='python.gif')

label = Label(window,image=img,bg='yellow')

# Half size image object from first image
...
# Creates a canvas and paints the small image above colored background, then paints a diagonal line over the top of it
can = \
